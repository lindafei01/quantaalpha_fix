...
it is not binding to the scenarios or framework (So it is not placed in quantaalpha.core.utils)
"""

# TODO: merge the common utils in `quantaalpha.core.utils` into this folder
